...
expected_mm = {'mulens': {'t_0': [6836.20, 0.11], 'u_0': [-0.840, 0.002], 't_E': [24.27, 0.16],
                          'pi_E_N': [0.192, 0.043], 'pi_E_E': [0.222, 0.008]},
               'physical': {'v_tilde_hel':
                            {'N': [158.3, 4.7], 'E': [212.4, 36.3]}}
               }  # X2 = 274.1
expected_pp = {'mulens': {'t_0': [6836.07, 0.10], 'u_0': [0.840, 0.002], 't_E': [23.92, 0.15],
                          'pi_E_N': [-1.292, 0.029], 'pi_E_E': [-0.052, 0.018]},
               'physical': {'v_tilde_hel':
                            {'N': [-56.4, 1.3], 'E': [26.7, 0.7]}}
               }  # X2 = 281.8
expected_pm = {'mulens': {'t_0': [6835.95, 0.11], 'u_0': [-0.840, 0.002], 't_E': [23.93, 0.15],
