...
% developer-facing list: it carries the SAME numbered claims C1-C29, and
...
% In step through C28; C29 (band-extinction convention) is in this repo's
% pair only and OWED to the paper.  It cannot ride the same commit, so
