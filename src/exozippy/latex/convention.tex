...
numerically to machine precision against \texttt{MulensModel}'s
implementation, is $\Omega = \phi_\pi - \xi_\Omega$,
$i = 180^\circ - \xi_i$, $\omega_* = \xi_\omega$,
$\xi_a = a_1/(D_{\rm S}\,\theta_{\rm E})$, with the phase carried by
$\nu(t_{0,\xi}) = \xi_u - \xi_\omega$ --- the same
toward-the-observer third-axis flip as C24's frame mapping.
