...
% developer-facing list: it carries the SAME numbered claims C1-C25, and
...
% It cannot ride the same commit, so it is the copy most likely to drift
% -- paper3 gained C26-C28 (the Keplerian reconciliation, which body's
% omega, the node fold and the third-axis trap) before this file did.
% When you change a C-rule, decide explicitly whether the paper moves
% too, and say so in the commit message when it does not.
% =====================================================================
